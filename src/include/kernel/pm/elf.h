...
/*! Type of addresses.  */
typedef UINT32 ELF32_ADDRESS;
typedef UINT64 ELF64_ADDRESS;

/*! Type of file offsets.  */
typedef UINT32 ELF32_OFFSET;
typedef UINT64 ELF64_OFFSET;
...
typedef UINT32 ELF32_SYMBOL_INDEX;
typedef UINT64 ELF64_SYMBOL_INDEX;
...
typedef struct
{
	...
	ELF32_ADDRESS	sh_addr;		/*! Section virtual addr at execution */
	ELF32_OFFSET	sh_offset;		/*! Section file offset */
...
typedef struct
{
	...
	ELF64_ADDRESS	sh_addr;		/*! Section virtual addr at execution */
	ELF64_OFFSET	sh_offset;		/*! Section file offset */
...
typedef struct
{
	...
	ELF32_ADDRESS	st_value;		/*! Symbol value */
...
typedef struct
{
	...
	ELF32_OFFSET	p_offset;	/*! Segment file offset */
	ELF32_ADDRESS	p_vaddr;	/*! Segment virtual address */
	ELF32_ADDRESS	p_paddr;	/*! Segment physical address */
...
typedef struct
{
	...
	ELF64_OFFSET	p_offset;	/*! Segment file offset */
	ELF64_ADDRESS	p_vaddr;	/*! Segment virtual address */
	ELF64_ADDRESS	p_paddr;	/*! Segment physical address */
...
/*! This vector is normally only used by the program interpreter.  The  usual definition in an ABI supplement uses the name auxv_t.  
   The  vector is not usually defined in a standard <elf.h> file, but it can't hurt.  We rename it to avoid conflicts.  The sizes of these
   types are an arrangement between the exec server and the program interpreter, so we don't fully specify them here.  */
...
/*! Values for ELF64_HEADER.e_flags.  */
...
/*! For Sparc64, legal values for d_tag of ELF64_DYNAMIC_SECTION.  */
...
/*! Legal values for e_flags field of ELF32_HEADER.  */
...
/*! Legal values for p_type field of ELF32_PROGRAM_HEADER.  */
...
/*! Legal values for d_tag field of ELF32_DYNAMIC_SECTION.  */
...
/*! Legal values for DT_MIPS_FLAGS ELF32_DYNAMIC_SECTION entry.  */
...
typedef ELF32_ADDRESS ELF32_CONFLICT;
...
#define R_PARISC_PCREL17C	7	/*! Conditional PC-relative, ignore   if displacement > 17bits.  */
#define R_PARISC_PCREL17F	8	/*! Conditional PC-relative, must  fit in 17bits.  */
...
#define R_PARISC_DLTIND21L	15	/*! DLT-relative indirect, left 21 bits.  */
#define R_PARISC_DLTIND14R	16	/*! DLT-relative indirect, right 14 bits.  */
#define R_PARISC_DLTIND14F	17	/*! DLT-relative indirect, must fit int 14 bits.  */
#define R_PARISC_PLABEL32	18	/*! Direct 32-bit reference to proc.  */

/*! Alpha specific definitions.  */

/*! Legal values for e_flags field of ELF64_HEADER.  */

#define EF_ALPHA_32BIT		1	/*! All addresses must be < 2GB.  */
#define EF_ALPHA_CANRELAX	2	/*! Relocations for relaxing exist.  */

/*! Legal values for sh_type field of ELF64_SECTION_HEADER.  */

/*! These two are primerily concerned with ECOFF debugging info.  */
#define SHT_ALPHA_DEBUG		0x70000001
#define SHT_ALPHA_REGINFO	0x70000002

/*! Legal values for sh_flags field of ELF64_SECTION_HEADER.  */

#define SHF_ALPHA_GPREL		0x10000000

/*! Legal values for st_other field of ELF64_SYMBOL.  */
